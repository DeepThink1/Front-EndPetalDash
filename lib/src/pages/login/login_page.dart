...
class LoginPage extends StatelessWidget {
  ...
  LoginControler con = Get.put(LoginControler());
...
Widget _textDontHaveAccount(){
  LoginControler controlador = Get.put(LoginControler());
...
Widget _boxForm(BuildContext context){
  return Container(
    margin: EdgeInsets.only(top: MediaQuery.of(context).size.height * 0.43, left: 50, right: 50),
